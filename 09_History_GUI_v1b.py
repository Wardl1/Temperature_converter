...
changed 3 references to all_calulations to all_calc_list (lines 21, 83 adn 86)
(to match 10_Assembled_Converter)
Changed the name of the calc_history button to history_button (lines 78 and 84)
Added the lambda command at lines 82-83
Disabled the history button (lines 86-87) if nothing in the all_calc_list
"""
